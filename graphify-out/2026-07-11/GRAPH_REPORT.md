...
## Corpus Check
- 147 files · ~24,872 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1373 nodes · 2329 edges · 263 communities (50 shown, 213 thin omitted)
- Extraction: 82% EXTRACTED · 18% INFERRED · 0% AMBIGUOUS · INFERRED: 409 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `620bcb9d`
...
## Communities (263 total, 213 thin omitted)
...
Cohesion: 0.23
Nodes (12): SupervisorRequestData, SupervisorRequestKind, SupervisorRequestInterface, ProcessInfoData, RequestInfoData, SupervisorError, TaskRecord, TaskRuntime (+4 more)
...
Cohesion: 0.06
Nodes (19): HttpKernel, Middleware, MiddlewarePipeline, json_response(), JSONResponse, response(), ResponseFactory, ApiUser (+11 more)
...
Cohesion: 0.20
Nodes (3): ErrorKindInterface, Enforces that any error type object has a code string and message string., GenericError
...
Cohesion: 0.17
Nodes (7): Error, Accepts any Enum instance that implements a .message property., ModuleLoader, ModuleLoaderError, TypeDiscoveryError, TypeDiscoveryServiceProvider, ModuleType
...
Cohesion: 0.26
Nodes (8): Application, ApplicationError, ApplicationException, ApplicationStatus, DefaultApplication, ConsoleServiceProvider, HttpServiceProvider, StrEnum
...
Cohesion: 0.13
Nodes (6): app() facade, Api, Controllers for API routes, LifecycleController, ApiResponseData, ApiStatus
