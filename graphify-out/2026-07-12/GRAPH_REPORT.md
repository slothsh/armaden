...
## Corpus Check
- 191 files · ~33,775 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1770 nodes · 2991 edges · 325 communities (60 shown, 265 thin omitted)
- Extraction: 81% EXTRACTED · 19% INFERRED · 0% AMBIGUOUS · INFERRED: 572 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ffaaa2ed`
...
## Communities (325 total, 265 thin omitted)
...
Cohesion: 0.24
Nodes (4): Result, Self, ArmaReforgerServer, TaskRuntimeInterface
...
Cohesion: 0.29
Nodes (4): RconCommandInterface, SendCommandProtocol, Mixin adding registered RCON command dispatch to any client that     exposes a `, RegisteredRconClient

### Community 86 - ".keep_crash_files"
Cohesion: 0.25
Nodes (6): ArmaReforgerRconClient, ArmaReforgerServerConfig, ArmaReforgerServerError, ArmaReforgerServerException, ExecutableContainer, PathContainer

### Community 96 - ".region"
Cohesion: 0.33
Nodes (5): BattleEyeRconClient, RegisteredRconClient, RegistersRconCommand, ArmaReforgerRconClient, High-level RCON client for Arma Reforger.      Command registration, dispatch, a

### Community 310 - "RegisteredRconClient"
Cohesion: 0.15
Nodes (9): BanRemoveCommand, Any, IdCommand, LoginCommand, LogoutCommand, PlayersCommand, RestartCommand, RolesCommand (+1 more)
