# Graph Report - feature-filesystem-storage-worktree  (2026-07-19)

## Corpus Check
- 222 files · ~46,264 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2242 nodes · 4389 edges · 299 communities (86 shown, 213 thin omitted)
- Extraction: 83% EXTRACTED · 17% INFERRED · 0% AMBIGUOUS · INFERRED: 763 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1ea0c0a3`
...
## Communities (299 total, 213 thin omitted)
...
- **Why does `InstanceContainer` connect `InstanceContainer` to `DefaultApplication`, `.get_alias`, `PlayerResponseData`, `WorkerPool`, `RconCommandArgumentError`, `ContextualAttribute`, `RconCommandInterface`, `.resolve_primitive`, `BattleEyeRconClient`, `.addons_verify`, `SubprocessHandle`, `Exception`, `Message`, `.resolve`, `Kernel`, `.log_append`, `HttpServiceProvider`?**
...
- **Why does `ArmaReforgerServerException` connect `ServiceProvider` to `ArmaReforgerServerExecutable`, `lifecycle_controller.py`, `RouteFacade`, `.generate`, `Exception`, `Task`, `TaskGraph`?**
