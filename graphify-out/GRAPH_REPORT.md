...
## Communities (134 total, 85 thin omitted)

### Community 1 - "Supervisor Request Handling"
Cohesion: 0.10
Nodes (19): Future, SupervisorRequestArgs, SupervisorRequestData, HealthStatus, SupervisorRequestKind, ProcessInfoData, AbstractEventLoop, Any (+11 more)
...
Cohesion: 0.06
Nodes (30): Any, ArmaReforgerServerConfig, Result, Self, config(), env(), Any, Facade for reading typed environment variables from the application. (+22 more)
...
Cohesion: 0.08
Nodes (21): ABC, BoundMethod, Configurable, _resolve_config_type(), SelfBuilding, DeferrableProvider, Any, Result (+13 more)
...
Cohesion: 0.08
Nodes (22): AppServiceProvider, Application, ApplicationBase, armaden.framework, Application (ApplicationBase), ServiceProvider, TaskBuilder, app() facade (+14 more)
...
Cohesion: 0.26
Nodes (6): ModuleType, ModuleLoader, Any, Result, Result, TypeDiscoveryServiceProvider

### Community 78 - "Package Init Module"
Cohesion: 0.09
Nodes (13): Exception, CircularDependencyException, EntryNotFoundException, LogicException, Any, route(), URL, request() (+5 more)
...
Cohesion: 0.28
Nodes (6): TypeDiscoveryError, ArmaReforgerExecutableFlag, ArmaReforgerExecutableFlagError, Result, Arma Reforger CLI startup flags., StrEnum

### Community 125 - "Dictionary"
Cohesion: 0.19
Nodes (4): ModuleLoaderError, Dictionary, Any, Config
