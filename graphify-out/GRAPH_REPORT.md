...
## Corpus Check
- 141 files · ~23,762 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1335 nodes · 2647 edges · 141 communities (51 shown, 90 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 257 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `35d2c1e6`
...
Cohesion: 0.12
Nodes (7): AbstractEventLoop, InstanceContainer, CoreApplication, Any, Result, ServiceProvider, SupervisorInterface
...
Cohesion: 0.06
Nodes (19): Application, Protocol, Application, ErrorInterface, CoreApplicationInterface, KernelInterface, Any, Result (+11 more)
...
Cohesion: 0.16
Nodes (9): Any, ApplicationInterface, Path, ApplicationInterface, ApplicationError, ApplicationException, ApplicationStatus, HttpServiceProvider (+1 more)
...
Cohesion: 0.12
Nodes (14): AppServiceProvider, ApplicationBase, armaden.framework, Application (ApplicationBase), ServiceProvider, TaskBuilder, armaden.framework.runtime, armaden runtime CLI (+6 more)
...
Cohesion: 0.16
Nodes (10): ArmaReforgerExecutableFlag, ArmaReforgerExecutableFlagError, Result, Arma Reforger CLI startup flags., SteamCMD CLI command flags (prefixed with ``+``)., SteamCmdExecutableFlag, SteamCmd — Python wrapper for the steamcmd CLI tool., Config (+2 more)
