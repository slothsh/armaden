...
## Corpus Check
- 294 files · ~57,804 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3031 nodes · 6213 edges · 431 communities (133 shown, 298 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 817 edges (avg confidence: 0.55)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6ba9702f`
...
- `TaskBuilderProtocol` --uses--> `TaskProtocol`  [INFERRED]
  src/armaden/framework/protocols/task_builder_protocol.py → src/armaden/framework/protocols/task_protocol.py
- `_BuiltCallbacks` --uses--> `TaskBuilderProtocol`  [INFERRED]
  src/armaden/framework/runtime/supervisor/task/task_builder.py → src/armaden/framework/protocols/task_builder_protocol.py
- `_BuiltTask` --uses--> `TaskBuilderProtocol`  [INFERRED]
  src/armaden/framework/runtime/supervisor/task/task_builder.py → src/armaden/framework/protocols/task_builder_protocol.py
- `TaskBuilder` --uses--> `TaskBuilderProtocol`  [INFERRED]
  src/armaden/framework/runtime/supervisor/task/task_builder.py → src/armaden/framework/protocols/task_builder_protocol.py
- `PolicyEngineProtocol` --uses--> `TaskProtocol`  [INFERRED]
  src/armaden/framework/protocols/policy_engine_protocol.py → src/armaden/framework/protocols/task_protocol.py
...
Cohesion: 0.14
Nodes (13): PolicyEngineProtocol, Enum, G, Result, TaskRuntimeProtocol, Enum, G, TaskRuntimeProtocol (+5 more)

### Community 14 - "app"
Cohesion: 0.15
Nodes (9): Enum, E, Result, TaskRuntimeProtocol, TaskProtocol, TaskStateData, SupervisorError, TaskPolicyProtocol (+1 more)
...
Cohesion: 0.05
Nodes (20): Event, ProgressChannel, ProgressUpdate, AbstractEventLoop, Any, AsyncStreamCallback, Path, Result (+12 more)
...
Cohesion: 0.21
Nodes (6): TaskGraph, Enum, TaskGraphCompiler, Enum, TaskRuntimeProtocol, TaskInjector
...
Cohesion: 0.10
Nodes (8): register_builtin_attributes(), ApplicationException, CoreApplication, AbstractEventLoop, Any, Result, DefaultApplication, Result

### Community 59 - "URL"
Cohesion: 0.22
Nodes (6): Protocol, BoundMethodProtocol, ContainerInstanceProtocol, ContainerProtocol, ContextualAttributeProtocol, Parameter
...
Cohesion: 0.10
Nodes (13): create_filesystem(), ApplicationError, ApplicationStatus, CacheServiceProvider, Result, ConsoleServiceProvider, Result, FilesystemServiceProvider (+5 more)
...
Cohesion: 0.14
Nodes (5): Self, E, TaskCallback, TaskStatusCallback, TaskBuilderProtocol
...
Cohesion: 0.24
Nodes (5): DefaultApi, DefaultApiError, Any, FastAPI, Result
...
Cohesion: 0.10
Nodes (11): AbstractEventLoop, ConcurrencyFacade, Container, Future, ProcessFacade, ScheduleFacade, SchedulerProtocol, Result (+3 more)
...
Cohesion: 0.30
Nodes (6): Error, GraphTaskRuntime, Semaphore, TaskGraph, TaskRuntimeProtocol, TaskInjector
...
Cohesion: 0.12
Nodes (6): DeferrableProvider, Any, Result, ServiceProvider, HealthStatus, RconServiceProvider

### Community 364 - "DatagramTransportInterface"
Cohesion: 0.40
Nodes (3): _MasoniteModel, Model, Base ORM model for armaden applications.      Extends masoniteorm's Model, overr

### Community 391 - "Self"
Cohesion: 0.10
Nodes (3): TaskCallback, TaskStatusCallback, TaskBuilder

### Community 393 - "TaskGraph"
Cohesion: 0.18
Nodes (7): Exception, CircularDependencyException, EntryNotFoundException, LogicException, CircularDependencyException, EntryNotFoundException, LogicException

### Community 397 - "ModuleLoader"
Cohesion: 0.35
Nodes (4): ModuleType, ModuleLoader, Any, Result

### Community 400 - "ErrorProtocol"
Cohesion: 0.22
Nodes (3): Error, ErrorKindProtocol, ErrorProtocol

### Community 413 - "TaskInjector"
Cohesion: 0.53
Nodes (4): BuiltTaskCallback, _BuiltTask, Result, TaskRuntimeProtocol

### Community 414 - "TaskInjectorProtocol"
Cohesion: 0.16
Nodes (7): Result, TaskPolicy, TaskRuntimeProtocol, TaskThreadingPolicy, Task, TaskGraph, TaskInjectorProtocol

### Community 419 - "E"
Cohesion: 0.33
Nodes (3): _BuiltCallbacks, TaskPolicy, TaskThreadingPolicy
...
### Community 425 - "TaskGraphCompilerProtocol"
Cohesion: 0.50
...
- **Why does `ErrorInterface` connect `ErrorInterface` to `__init__.py`, `__init__.py`, `CoreApplicationInterface`, `SupervisorRequestKind`, `SupervisorInterface`, `CacheProtocol`, `.make`, `S3Filesystem`, `URL`?**
...
- **Why does `Filesystem` connect `ErrorInterface` to `__init__.py`, `arma_reforger_server_executable.py`, `__init__.py`, `SupervisorRequestKind`, `Packet`, `.make`, `S3Filesystem`, `Storage`?**
