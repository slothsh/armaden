"""BattlEye RCON client implementation using :mod:`berconpy`."""
...
from .rcon_client import RconClient, RconClientError, RconClientConnectionError

logger = logging.getLogger('armaden.framework.classes.battle_eye_rcon_client')


class BattleEyeRconClient(RconClient):
    """Concrete BattlEye RCON client wrapper around :mod:`berconpy`.
    ...
    async def send(self, command: str) -> str:
        ...
        """
        if not self._client.is_running():
            raise RconClientConnectionError("RCON client is not connected")
