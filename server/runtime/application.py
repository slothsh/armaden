...
from runtime.default_application import DefaultApplication
from runtime.module_loader import ModuleLoader

logger = logging.getLogger('runtime.application')
...
class CoreApplication:
    ...
    def __init__(self) -> None:
        ...
        from framework.facades._registry import set_application
    ...
    def register_base_service_providers(self) -> None:
        from runtime.providers.http_service_provider import HttpServiceProvider
        from runtime.providers.console_service_provider import ConsoleServiceProvider
