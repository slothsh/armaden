...
- Put state-bearing runtime records and structured entries in DTO modules as dataclasses. Use an abstract base implementation for shared runtime behavior when specialized variants inherit from it.
